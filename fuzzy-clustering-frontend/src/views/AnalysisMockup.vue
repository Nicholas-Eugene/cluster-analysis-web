    ...
    <div class="container">
      <div class="page-header">
        ...
        <div class="mockup-notice">
          <strong>🎭 Mode Demo:</strong> Menampilkan hasil clustering dengan data simulasi Indonesia
        </div>
      </div>
...
export default {
  ...
  setup() {
    ...
    const exportToCSV = () => {
      ...
      a.href = url
      a.download = 'clustering_results_demo.csv'
    ...
    const exportToJSON = () => {
      ...
      const a = document.createElement('a')
      a.href = url
      a.download = 'clustering_results_demo.json'
      document.body.appendChild(a)
      a.click()
      document.body.removeChild(a)
      window.URL.revokeObjectURL(url)
    ...
    const exportCharts = () => {
      if (scatterChartInstance.value) {
        ...
        const a = document.createElement('a')
        a.href = url
        a.download = 'scatter_plot_demo.png'
        document.body.appendChild(a)
        a.click()
        document.body.removeChild(a)
      }
