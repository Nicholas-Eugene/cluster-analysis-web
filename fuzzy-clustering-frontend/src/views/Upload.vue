    ...
    <div class="container">
      ...
      <div class="actions">
        ...
        >
          ...
          {{ isProcessing ? 'Memproses...' : 'Mulai Clustering' }}
        </button>
...
export default {
  ...
  setup() {
    ...
    const availableYears = computed(() => {
      ...
      const years = new Set()
      dataPreview.value.sampleRows.forEach(row => {
    ...
    const previewData = async (file) => {
      try {
        ...
        if (lines.length < 2) {
          uploadError.value = 'File harus memiliki minimal 2 baris (header + data)'
          return
        }
        ...
        uploadError.value = 'Error membaca file. Pastikan format CSV valid'
      }
    }
